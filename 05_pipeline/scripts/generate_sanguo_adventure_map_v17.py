...
DEFAULT_OUTPUT = REPO_ROOT / "graphrag-demo/三國演義探險地圖_v17.html"
...
def build_payload(nodes_path: Path, rels_path: Path, metadata_path: Path) -> dict[str, Any]:
    ...
    return {
        "version": "v17-visual-style-system-relation-toolbar",
        "title": "三國演義探險地圖",
        "generatedFrom": {
...
<head>
  ...
  <style>
    ...
    body.style-bamboo {
      ...
      --mixed-text: #5A3F22;
      --neutral-bg: #EFE6D2;
      --neutral-border: #BAA57B;
      --neutral-text: #5A4828;
      --link-ally: #6B9567;
      --link-enemy: #A95A45;
      --link-defeat: #8E4A39;
      --link-strategy: #B88730;
      --link-command: #718D53;
      --link-family: #9A765B;
      --link-story: #8E7E62;
      --link-place: #6D8D82;
      ...
      --ink: #273427;
      --muted: #6A644F;
      --line: rgba(92, 77, 47, 0.20);
      --strong-line: rgba(92, 77, 47, 0.38);
      --shadow: 0 14px 32px rgba(70, 52, 24, 0.14);
      --focus: 0 0 0 3px rgba(139, 107, 51, 0.28);
    }
    ...
    body.style-warroom {
      ...
      --mixed-text: #F0E6FF;
      --neutral-bg: #2C3441;
      --neutral-border: #9AA9B8;
      --neutral-text: #ECF2F8;
      --link-ally: #63B5F6;
      --link-enemy: #F08391;
      --link-defeat: #FF6B6B;
      --link-strategy: #F4C95D;
      --link-command: #9ED678;
      --link-family: #C9A8FF;
      --link-story: #B8C0CC;
      --link-place: #8BD6CE;
      ...
      --ink: #EEF6F8;
      --muted: #B3C1C8;
      --line: rgba(184, 207, 219, 0.20);
      --strong-line: rgba(184, 207, 219, 0.42);
      --shadow: 0 18px 52px rgba(0, 0, 0, 0.38);
      --focus: 0 0 0 3px rgba(95, 168, 232, 0.34);
    }
    ...
    * { box-sizing: border-box; }
    ...
    body.style-bamboo {
      background:
        linear-gradient(90deg, rgba(122, 102, 62, 0.08) 1px, transparent 1px),
        linear-gradient(0deg, rgba(122, 102, 62, 0.06) 1px, transparent 1px),
        radial-gradient(circle at 12% 12%, rgba(183, 139, 48, 0.13), transparent 30%),
        var(--bg);
    ...
    body.style-warroom {
      background:
        linear-gradient(90deg, rgba(95, 168, 232, 0.10) 1px, transparent 1px),
        linear-gradient(0deg, rgba(244, 201, 93, 0.08) 1px, transparent 1px),
        radial-gradient(circle at 70% 18%, rgba(95, 168, 232, 0.18), transparent 32%),
        radial-gradient(circle at 24% 84%, rgba(240, 131, 145, 0.14), transparent 30%),
        var(--bg);
    ...
    body.style-bamboo button,
    body.style-bamboo input,
    body.style-bamboo select,
    body.style-bamboo textarea {
      background: #FFF8E8;
      border-color: rgba(128,102,54,0.26);
    }

    body.style-warroom button,
    body.style-warroom input,
    body.style-warroom select,
    body.style-warroom textarea {
      color: var(--ink);
      background: #172432;
      border-color: rgba(184,207,219,0.24);
    }

    body.style-warroom input::placeholder {
      color: #8EA0AA;
    }
    ...
    body.style-bamboo .topbar,
    body.style-bamboo .panel,
    body.style-bamboo .workspace > .person-card,
    body.style-bamboo .workspace > .moments-card {
      background:
        linear-gradient(135deg, rgba(255,248,232,0.96), rgba(245,233,206,0.9));
      border-color: rgba(128, 102, 54, 0.24);
      box-shadow: var(--shadow);
    }

    body.style-warroom .topbar,
    body.style-warroom .panel,
    body.style-warroom .workspace > .person-card,
    body.style-warroom .workspace > .moments-card {
      background:
        linear-gradient(135deg, rgba(23,33,43,0.96), rgba(17,26,36,0.92));
      border-color: rgba(184,207,219,0.22);
      box-shadow: var(--shadow);
    }
    ...
    .font-scale-inline button.is-active {
      color: var(--wei-text);
      border-color: var(--wei-border);
    ...
    body.mode-person .roster-controls {
      flex: 0 0 auto;
      max-height: none;
      overflow: visible;
      border-bottom: 1px solid rgba(109,196,148,0.24);
    }
    ...
    body.mode-person .hero-chooser-panel {
      border-bottom-color: rgba(109,196,148,0.26);
    }

    body.mode-battle .hero-chooser-panel .camp-filter-panel,
    body.mode-relation .hero-chooser-panel .camp-filter-panel {
      display: none;
    }

    body.mode-person .roster-list {
      flex: 1 1 auto;
      min-height: 0;
    }
    ...
    body.mode-person .relation-section {
      box-shadow: 0 4px 10px rgba(39,61,52,0.04);
    }

    body.mode-person .relation-section.compact {
      border-left-width: 4px;
      border-radius: 14px;
      overflow: hidden;
    }

    body.mode-person .relation-compact-head {
      min-height: 34px;
      display: flex;
      align-items: center;
      justify-content: space-between;
    ...
    body.mode-person .relation-compact-head strong {
      font-size: 13px;
      line-height: 1.15;
    }

    body.mode-person .relation-compact-head span {
      min-width: 24px;
      height: 24px;
      display: grid;
      place-items: center;
    ...
    body.mode-person .relation-compact-items {
      display: grid;
      gap: 4px;
      padding: 6px;
      max-height: 152px;
    ...
    body.mode-person .relation-compact-row {
      display: grid;
      grid-template-columns: minmax(48px, 0.42fr) minmax(0, 1fr);
      gap: 6px;
      align-items: center;
      min-height: 34px;
      padding: 5px 6px;
      border: 1px solid rgba(196,184,168,0.45);
      border-radius: 9px;
      background: rgba(255,253,247,0.94);
    }

    body.mode-person .relation-compact-row button {
      min-height: 24px;
      padding: 0;
      border: 0;
      background: transparent;
    ...
    body.mode-person .relation-compact-row span {
      color: var(--muted);
      font-size: 11px;
      font-weight: 800;
      line-height: 1.3;
    ...
    body.style-bamboo .map-zone {
      background:
        radial-gradient(circle at 16% 18%, rgba(148, 128, 72, 0.18), transparent 32%),
        linear-gradient(90deg, rgba(120, 95, 48, 0.10) 1px, transparent 1px),
        linear-gradient(0deg, rgba(120, 95, 48, 0.08) 1px, transparent 1px),
        #F8EED8;
      background-size: auto, 46px 46px, 46px 46px, auto;
    }

    body.style-warroom .map-zone {
      background:
        radial-gradient(circle at 20% 24%, rgba(95,168,232,0.14), transparent 30%),
        radial-gradient(circle at 74% 74%, rgba(240,131,145,0.12), transparent 28%),
        linear-gradient(90deg, rgba(95,168,232,0.13) 1px, transparent 1px),
        linear-gradient(0deg, rgba(244,201,93,0.10) 1px, transparent 1px),
        #101722;
      background-size: auto, auto, 32px 32px, 32px 32px, auto;
      border-color: rgba(95,168,232,0.32);
    }
    ...
    body.mode-battle .relation-groups-card .person-file {
      display: none;
    }

    body.mode-battle .relation-groups-card .mode-summary {
      display: grid;
    }
    ...
    .path-summary-mini {
      ...
      border: 1px solid rgba(211,165,64,0.36);
      border-radius: var(--radius);
      background: linear-gradient(135deg, rgba(255,242,204,0.48), rgba(255,255,255,0.96));
    }

    .battle-file-card h3,
    .path-summary-mini h3 {
      margin: 0;
      font-size: 16px;
      font-weight: 900;
      line-height: 1.25;
    ...
    body.mode-battle .person-card,
    body.mode-relation .person-card {
      border-color: rgba(122,174,212,0.36);
      background: linear-gradient(135deg, rgba(255,253,247,0.98), rgba(247,250,255,0.92));
    }

    body.mode-battle .person-relation-tabs,
    body.mode-relation .person-relation-tabs {
      display: flex;
      flex-wrap: wrap;
      gap: 6px;
    }

    body.mode-battle .person-relation-tabs button {
      color: #6E4B00;
      border-color: rgba(211,165,64,0.32);
      background: #fff;
    }

    body.mode-battle .person-relation-tabs button.is-active {
      color: #6E4B00;
      border-color: var(--link-strategy);
      background: #FFF2CC;
    }

    body.mode-relation .person-relation-tabs button {
      color: var(--wei-text);
      border-color: rgba(122,174,212,0.32);
      background: #fff;
    }

    body.mode-relation .person-relation-tabs button.is-active {
      color: var(--wei-text);
      border-color: var(--wei-border);
      background: var(--wei-bg);
    }
    ...
    body.style-bamboo .link {
      stroke-opacity: 0.34;
    }

    body.style-bamboo .node text {
      stroke: rgba(255,248,232,0.94);
      stroke-width: 5px;
    }

    body.style-bamboo .info-card,
    body.style-bamboo .profile-card,
    body.style-bamboo .relation-compact-row,
    body.style-bamboo .event-item,
    body.style-bamboo .path-evidence,
    body.style-bamboo .battle-evidence-card {
      background: #FFF8E8;
      border-color: rgba(128,102,54,0.24);
    }

    body.style-warroom .hint {
      color: #DDEBFF;
      background: rgba(16,24,32,0.72);
      border-color: rgba(95,168,232,0.32);
    }

    body.style-warroom .link {
      stroke-opacity: 0.32;
    }

    body.style-warroom .link.is-highlighted,
    body.style-warroom .link.is-path-main {
      stroke-opacity: 0.95;
      filter: drop-shadow(0 0 5px rgba(244,201,93,0.32));
    }

    body.style-warroom .node text {
      fill: var(--ink);
      stroke: rgba(16,24,32,0.92);
      stroke-width: 6px;
    }

    body.style-warroom .info-card,
    body.style-warroom .profile-card,
    body.style-warroom .relation-compact-row,
    body.style-warroom .event-item,
    body.style-warroom .path-evidence,
    body.style-warroom .battle-evidence-card {
      background: #172432;
      border-color: rgba(184,207,219,0.22);
    }
...
<body>
  <div class="app">
    <header class="topbar">
      ...
      <div class="top-actions">
        ...
        <div class="font-scale-inline" id="fontScaleOptions" aria-label="字體大小">
          <span>字</span>
          <button type="button" data-font-scale="small">小</button>
          <button type="button" data-font-scale="normal" class="is-active">中</button>
          <button type="button" data-font-scale="large">大</button>
        </div>
    ...
    <main class="workspace">
      <aside class="panel roster">
        ...
        <div class="hero-chooser-panel" id="heroChooserPanel">
      ...
      <aside class="panel guide">
        ...
        <div class="guide-scroll">
          ...
          <section class="info-card relation-groups-card is-visible" id="relationGroupsCard">
            ...
            <div class="mode-summary" id="modeSummaryPanel"></div>
          </section>
    ...
    <aside id="settingsDrawer" class="settings-drawer" aria-label="顯示設定" aria-hidden="true">
      ...
      <div class="drawer-body">
        <section class="settings-section">
          <h3>整體風格</h3>
          <p class="settings-note">切換整體配色、背景、卡片質感與地圖呈現方法。</p>
          <div class="segmented-options" id="styleOptions">
            <button type="button" data-style="classic" class="is-active">經典</button>
            <button type="button" data-style="bamboo">竹簡</button>
            <button type="button" data-style="warroom">沙盤</button>
          </div>
        </section>
        <section class="settings-section">
          <h3>地圖密度</h3>
  ...
  (() => {
    ...
    const state = {
      ...
      personRelationTab: "",
      visualStyle: ["classic", "bamboo", "warroom"].includes(savedSettings.visualStyle) ? savedSettings.visualStyle : "classic",
    ...
    const dom = {
      ...
      modeSummaryPanel: document.getElementById("modeSummaryPanel"),
    ...
    function renderReaderTabs() {
      if (state.mode === "battle") {
        dom.personRelationTabs.replaceChildren(...BATTLE_STEPS.map(item => {
          const button = document.createElement("button");
          button.type = "button";
          button.className = item.id === state.battleStep ? "is-active" : "";
      ...
      if (state.mode === "relation") {
        const tabs = [
          { id: "main", label: "主線" },
          { id: "story", label: "戰役/事件" },
          { id: "interaction", label: "互動" },
          { id: "identity", label: "身分" },
        ];
        dom.personRelationTabs.replaceChildren(...tabs.map((item, index) => {
          const button = document.createElement("button");
          button.type = "button";
          button.className = index === 0 ? "is-active" : "";
          button.dataset.pathReaderTab = item.id;
          button.textContent = item.label;
          return button;
        }));
        return;
    ...
    function bindEvents() {
      ...
      dom.personRelationTabs.addEventListener("click", event => {
        const battleButton = event.target.closest("button[data-battle-step]");
        if (battleButton) {
          chooseBattleStep(battleButton.dataset.battleStep);
          return;
        }
        const pathButton = event.target.closest("button[data-path-reader-tab]");
        if (pathButton) {
          [...dom.personRelationTabs.children].forEach(child => child.classList.toggle("is-active", child === pathButton));
          renderPathReader(state.pathIds, pathButton.dataset.pathReaderTab);
          return;
        }
        const button = event.target.closest("button[data-person-relation-tab]");
        if (!button) return;
        state.personRelationTab = state.personRelationTab === button.dataset.personRelationTab ? "" : button.dataset.personRelationTab;
      ...
      dom.searchInput.addEventListener("input", debounce(() => {
        ...
        if (state.mode === "battle") {
          ...
          if (dom.battleSearchInput) dom.battleSearchInput.value = state.query;
    ...
    function applyDisplaySettings(shouldPersist = true) {
      document.body.classList.toggle("style-bamboo", state.visualStyle === "bamboo");
      document.body.classList.toggle("style-warroom", state.visualStyle === "warroom");
    ...
    function updateScenarioChrome() {
      ...
      dom.relationGroupsCard.classList.toggle("is-visible", state.mode === "person" || state.mode === "battle");
      ...
      const hideMainSearch = false;
      dom.searchLabel.style.display = hideMainSearch ? "none" : "";
      dom.searchInput.parentElement.style.display = hideMainSearch ? "none" : "";
      dom.battleSearchCard.classList.toggle("is-visible", false);
      dom.guideTitle.textContent = state.mode === "battle" ? "戰役檔案" : (state.mode === "relation" ? "路徑摘要" : "人物檔案");
      dom.eventBookTitle.textContent = state.mode === "battle" ? "戰役檔案" : "人物檔案";
      dom.eventBookSubtitle.textContent = state.mode === "battle" ? "核心問題、參與者與勝負轉折。" : "人物簡介、關鍵時刻與書中脈絡。";
      dom.relationReaderTitle.textContent = state.mode === "battle" ? "四步推理板" : (state.mode === "relation" ? "路徑分段閱讀" : "關係人物");
      dom.relationReaderHint.textContent = state.mode === "battle"
        ? "照原因、決策、行動、結果讀證據。"
        : (state.mode === "relation" ? "每一段都標出戰役、互動或身分線索。" : "他們是什麼樣的關係呢？");
      dom.personRelationTabs.style.display = (state.mode === "person" || state.mode === "battle" || state.mode === "relation") ? "" : "none";
      renderReaderTabs();
    ...
    function renderRelationGroups(selected, preset) {
      ...
      const activeTab = PERSON_RELATION_TABS.find(tab => tab.id === state.personRelationTab) || null;
      const readableGroups = new Set(PERSON_RELATION_TABS.flatMap(tab => tab.groups));
      const groups = relationGroupsFor(selected.id, preset, { includeAllCategories: true })
        .filter(group => activeTab ? activeTab.groups.includes(group.id) : readableGroups.has(group.id));
      if (!groups.length) {
      ...
      dom.relationGroups.replaceChildren(...groups.map(group => {
        ...
        section.className = `relation-section compact cat-${group.id}`;
        const head = document.createElement("div");
        head.className = "relation-compact-head";
        ...
        items.className = "relation-compact-items";
        group.items.slice(0, 6).forEach(item => {
          const row = document.createElement("div");
          row.className = "relation-compact-row";
    ...
    function renderBattleSummary(preset) {
      if (!dom.modeSummaryPanel) return;
      if (state.mode !== "battle") {
        dom.modeSummaryPanel.replaceChildren();
        return;
      }
      const lesson = activeBattleLesson(preset);
      if (!lesson) {
        dom.modeSummaryPanel.replaceChildren(emptyState("先選一場戰役。"));
        return;
      }
      const eventNode = battleEventForLesson(lesson, preset);
      const evidence = battleEvidenceItems(lesson, preset);
      const people = new Set(evidence.map(item => item.node).filter(node => node?.type === "character").map(node => node.id));
      const story = new Set(evidence.map(item => item.node).filter(node => node && isStoryNode(node)).map(node => node.id));
      const card = document.createElement("div");
      card.className = "battle-file-card";
      const title = document.createElement("h3");
      title.textContent = lesson.title;
      const intro = document.createElement("p");
      intro.textContent = `${lesson.theme}。${lesson.coreQuestion}`;
      const facts = document.createElement("div");
      facts.className = "battle-fact-grid";
      [
        { label: "章回", value: `第 ${chapterLabel(eventNode || lesson)} 回` },
        { label: "焦點人物", value: `${people.size} 位` },
        { label: "事件線索", value: `${story.size} 個` },
        { label: "目前步驟", value: activeBattleStep().label },
      ].forEach(item => {
        const fact = document.createElement("div");
        fact.className = "battle-fact";
        const strong = document.createElement("strong");
      ...
      note.textContent = "閱讀順序：先看地圖中心，再到下方依四步讀證據，最後回到這裡整理判斷。";
      card.append(title, intro, facts, note);
      dom.modeSummaryPanel.replaceChildren(card);
    }
    ...
    function renderPathResult(pathIds, message = "") {
      if (state.mode !== "relation") {
        dom.pathResult.replaceChildren();
        return;
      }
      if (message) {
        dom.pathResult.replaceChildren(emptyState(message));
        dom.relationGroups.replaceChildren(emptyState(message));
        return;
      }
      if (!pathIds || !pathIds.length) {
        dom.pathResult.replaceChildren(emptyState("先按「尋找兩人的連結」，系統會把路線拆成戰役 / 事件關係、互動關係、認識 / 身分關係。"));
        dom.relationGroups.replaceChildren(emptyState("左側選好兩個人物後，這裡會逐段顯示他們怎麼被故事連起來。"));
        return;
      }
      const preset = currentPreset();
      ...
      dom.pathResult.replaceChildren(overview);
      dom.relationGroups.replaceChildren(...cards);
      renderReaderTabs();
      renderPathReader(pathIds, "main");
    }

    function renderPathReader(pathIds, tab = "main") {
      if (state.mode !== "relation") return;
      if (!pathIds || !pathIds.length) {
        dom.relationGroups.replaceChildren(emptyState("左側選好兩個人物後，這裡會逐段顯示他們怎麼被故事連起來。"));
        return;
      }
      const cards = [...dom.relationGroups.querySelectorAll(".path-evidence")];
      cards.forEach(card => {
        const matched = tab === "main" || card.dataset.pathType === tab;
        card.style.display = matched ? "" : "none";
      });
      const visible = cards.filter(card => card.style.display !== "none");
      const oldEmpty = dom.relationGroups.querySelector(".path-filter-empty");
      if (oldEmpty) oldEmpty.remove();
      if (!visible.length) {
        const empty = emptyState("這一類暫時沒有路徑證據，請切回主線或換一組人物。");
        empty.classList.add("path-filter-empty");
        dom.relationGroups.append(empty);
      }
    }
    ...
    function labelForNode(node) {
      if (state.visualStyle === "warroom" && state.selectedId !== node.id && !state.pathIds.includes(node.id)) {
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate Sanguo Adventure Map v17 HTML.")
